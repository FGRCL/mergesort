...
void mergesort (int sourceArray[], int destinationArray[], int start, int end) {
    ...
    std::thread leftThread(mergesort, destinationArray, sourceArray, startLeft, endLeft);
    std::thread rightThread(mergesort, destinationArray, sourceArray, startRight, endRight);
